...
def quantum_brute_force(public_key_x, g_x, g_y, p, max_range):
...
if __name__ == "__main__":
  ...
  min_range = 999999999999999999
  max_range = 10000000000000000000
  ...
  private_key = quantum_brute_force(public_key_x, g_x, g_y, p, max_range)
  if private_key:
